	...
	public Sprite getSprite(int x, int y) {
		if(spritesLoaded) {
			...
			if(spriteID < loadedSprites.length) {
				...
				System.out.println("spriteID of " + spriteID + "is out of range with the length of " + loadedSprites.length + ".");
			}
		}
		else {
			System.out.println("SpriteSheet could not retrieve sprite with no loaded sprites.");
		}
		return null;
	}
